 ...
 class Top extends Component {
    ...
    render() {
        return (
            <div>
                <header>
                    <span className="sw"><img src={require("../../assets/img/sw.png")} ></img></span>
                    ...
                    <span className="cm"><span className="cart" onClick={this.cart}><img src={require("../../assets/img/cart.png")} /></span><span className="more" onClick={this.more}><img src={require("../../img/mo.png")} /></span></span>
